...
describe("Modified", () => {
  ...
  it("should try to fetch a new external ratio after every 2 swaps that go through", async () => {
    const [owner] = await ethers.getSigners();
    ...
    // }
    await liquidityPoolFactory.swap(swap1, parseEther("10"));
